         ...
         <br>
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="descripcionProducto" style="width:200px;height:100px">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <a href="productos_Admin.php" class="btn btn-primary">Aceptar</a>
                         <a href="productos_Admin.php" class="btn btn-primary">Cancelar</a>
                    </td>
                    <td>
