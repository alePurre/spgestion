        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right">
                    <li class="active"><a href="<?php echo base_url('usuario/Usuario'); ?>">Inicio</a></li>
                    <li id="promociones"><a href="<?php echo base_url('usuario/ExamenesRealizados'); ?>">Examenes Realizados</a></li>
                    <li id="preguntas"><a href="<?php echo base_url('usuario/ExamenesPendientes'); ?>">Examenes Pendientes</a></li>                  
                    <li id="contacto"><a href="<?php echo base_url('usuario/Perfil'); ?>">Mi perfil</a></li>    
