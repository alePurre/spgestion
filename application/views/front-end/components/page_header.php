        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li id="empresa"><a href="<?php echo base_url('application/controllers/usuarios_controller'); ?>">Ayuda</a></li>                 
                    <li id="contacto"><a href="<?php echo base_url('contacto'); ?>">Contacto</a></li>                    
                    <li><a class="btn" href="<?php echo base_url('php'); ?>">Ingresar</a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
    </div> 
